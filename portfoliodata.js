...
const aboutMe = `
    <div class="container">
        ...
        <br>
        <p>A long time ago in an office far, far away, I created a VBA script to solve an administrative problem. I pressed the play button and watched in wonderment as my computer crunched a two-hour task in a few seconds. From that moment, I was hopelessly, irrevocably hooked on using code to make computers do things.</p>
